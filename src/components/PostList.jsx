...
const PostList = ({posts, newSpend, setNewSpend, editPostTotal, deletePost, createExpense, 
                    dicreaseBank, filterExpensesByCategortKey, calculateCategoryAmount, updateExpensesArray, increaseBank}) => {
